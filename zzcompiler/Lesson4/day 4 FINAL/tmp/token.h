...
typedef enum {
  TK_NONE, TK_IDENT, TK_NUMBER, TK_FLOAT, TK_CHAR, TK_EOF, TK_STRING,
	...
	KW_WHILE, KW_DO, KW_FOR, KW_TO, KW_UNTIL, KW_REPEAT, KW_FLOAT, KW_STRING,

	SB_SEMICOLON, SB_COLON, SB_PERIOD, SB_COMMA,
	SB_ASSIGN, SB_ASSIGN_PLUS, SB_ASSIGN_MINUS, SB_ASSIGN_TIMES, SB_ASSIGN_SLASH, SB_ASSIGN_MOD,
