...
void initSymTab(void) {
  ...
  enterBlock(writeiProcedure->procAttrs->scope);
    param = createParameterObject("i", PARAM_VALUE, writeiProcedure);
  ...
  enterBlock(writecProcedure->procAttrs->scope);
    param = createParameterObject("ch", PARAM_VALUE, writecProcedure);
  ...
  enterBlock(writefProcedure->procAttrs->scope);
    param = createParameterObject("f", PARAM_VALUE, writefProcedure);
